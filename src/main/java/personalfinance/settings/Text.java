...
/*
Этот класс с константами
 */
final public class Text {
    private static final HashMap<String, String> data = new HashMap<String, String>();


    //Метод возвращает строку по ключу
    public static String get(String key) {
        return data.get(key);
    }

    //Метод, который возвращает массив всех месяцев
    ...
    public static void init() {
        data.put("PROGRAM NAME", "Домашняя бухгалтерия");
        data.put("MENU FILE", "Файл");
        data.put("MENU EDIT", "Правка");
        data.put("MENU VIEW", "Вид");
        data.put("MENU HELP", "Помощь");
